...
{
	// Opis jednej prowincji z mapy gry.
	public class ProvinceData
	{
		...
		// Domyślna żyzność porwincji bez uwzględnienia spadków żyzności.
		public int DefaultFertility { get; }
		// Klimat panujący w prowincji.
		public ClimateAndWeather.Climate Climate { get; }
		// Tradycje religijne w tej prowincji.
		public ProvinceTraditions Traditions { get; }
		// Regiony w tej prowincji.
		private readonly RegionData[] _regions;
		// Obecny spadek żyzności w prowincji (aktualizowany przez event).
		private int _currentFertilityDrop;
		// Sprawdzenie czy element XML jest poprawnym opisem prowincji.
