...
public static class RegionOperations
{
    ...
    public static Region Create(int id, string name, RegionType type, bool isCoastal, int? resourceId, string? resourceName, bool missingSlot)
    {
        if (id == 0)
        {
        ...
        return new Region(id, name, type, resourceId, resourceName, slots.ToImmutableArray());
    }
}