namespace TWBuildingAssistant.Model.Map
{
    ...
    public class RegionData
    {
        ...
        public RegionData(XElement element, bool isCity, Parser<IResource> resourceParser)
        {
            if (element == null)
            {
        ...
        public static bool ValidateElement(XElement element, Parser<IResource> resourceParser, out string message)
        {
