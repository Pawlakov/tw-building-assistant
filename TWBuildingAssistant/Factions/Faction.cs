...
namespace Faction
{
	...
	{
		public FactionException() : base("Bład w module technologii.") { }
		public FactionException(string message) : base(message) { }
		public FactionException(string message, Exception innerException) : base(message, innerException) { }
	}
}