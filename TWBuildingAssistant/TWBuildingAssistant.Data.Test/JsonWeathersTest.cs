namespace TWBuildingAssistant.Data.Test
{
    ...
    [TestFixture]
    public class JsonWeathersTest : JsonRepositoryTestBase
    {
        [Test]
        public void Read()
        {
            Assert.DoesNotThrow(() =>
            {
                var source = new JsonRepository<IWeather>();
            });
        }
        ...
        public void Any()
        {
            JsonRepository<IWeather> source = null;
            try
            {
                source = new JsonRepository<IWeather>();
            }
            catch
            {
                Assert.Inconclusive();
        ...
        {
            var source = this.GetRepository<IWeather>();
