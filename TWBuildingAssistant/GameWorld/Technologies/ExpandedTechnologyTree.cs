...
{
	// Rozszerzone drzewo technolgii (posiada 2 wykluczające się nawzajem gałęzie).
	// Budynki przypisane do poziomów gałęzi "legacy" stają się niedostępne po zbadaniu wykluczającej gałęzi.
	public class ExpandedTechnologyTree : ITechnologyTree
	{
		...
		// Sprawdza czy budynek przypisane do podanego poziomu jest dostępny.
