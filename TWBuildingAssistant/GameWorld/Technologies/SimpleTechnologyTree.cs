...
namespace GameWorld.Technologies
{
	...
	public class SimpleTechnologyTree : ITechnologyTree
	{
		...
		// Sprawdza czy podany poziom jest już zbadany przy zadanym porządanym poziomie technologii.
